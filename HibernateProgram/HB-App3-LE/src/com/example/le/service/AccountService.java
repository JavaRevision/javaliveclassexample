...
public class AccountService {
	...
	public static void main(String[] args) {
		...
		AccountBean accountBean = dao.getAccoountDetails(3);
		...
		//dao.deleteAccountDetails(3);
		 ...
		 AccountBean accountBeanNew = (AccountBean)session.get(AccountBean.class, 3L);
		  System.out.println("Account Details .. : ");
		  System.out.println("Account No .. : " + accountBeanNew.getAccNo());
		  System.out.println("Account Holder Name .. : " + accountBeanNew.getName());
		  System.out.println("Account Balnce .. : " + accountBeanNew.getBalance());
		  System.out.println("Account Creation Date .. : " +
		  accountBeanNew.getAccCreationDate());
